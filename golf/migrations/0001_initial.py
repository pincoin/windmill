# Generated by Django 2.2.4 on 2019-09-10 16:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'order made'), (1, 'order pending'), (2, 'payment_pending'), (3, 'voucher issued'), (4, 'order offered'), (5, 'order voided'), (6, 'refund requested'), (7, 'refund pending'), (8, 'order refunded(original)'), (9, 'order refunded(reverse)')], db_index=True, default=0, verbose_name='Booking status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Time offered'), (1, 'Time accepted'), (2, 'Time rejected'), (3, 'Time revoked'), (4, 'Time voided')], db_index=True, default=0, verbose_name='Tee-off time status')),
                ('booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='golf.Booking', verbose_name='Booking')),
            ],
            options={
                'verbose_name': 'Tee-off time',
                'verbose_name_plural': 'Tee-off time',
