# Generated by Django 2.2.4 on 2019-09-05 16:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'order pending'), (1, 'payment_pending'), (2, 'voucher issued'), (3, 'order revoked'), (4, 'refund requested'), (5, 'refund pending'), (6, 'order refunded(original)'), (7, 'order refunded(reverse)'), (8, 'order voided')], db_index=True, default=1, verbose_name='Booking status')),
