    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Time offered'), (1, 'Time accepted'), (2, 'Time rejected'), (3, 'Time revoked')], db_index=True, default=0, verbose_name='Tee-off time status')),
