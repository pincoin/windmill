# Generated by Django 2.2.4 on 2019-09-12 04:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day_of_week', models.IntegerField(choices=[(0, 'High/Weekday'), (1, 'High/Weekend'), (2, 'Low/Weekday'), (3, 'Low/Weekend')], db_index=True, default=0, verbose_name='Season / Day of week')),
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='golf.Club', verbose_name='Golf club')),
            ],
            options={
